# genpark-spatial-isochrone-reachability-analyzer-skill
...
**genpark-spatial-isochrone-reachability-analyzer-skill** is a deterministic, zero-dependency Python skill engineered for autonomous geospatial analysis, GeoJSON feature generation, and spatial reachability intelligence.

> **Executive Capability**: Multi-modal travel-time isochrone reachability boundary analyzer (Targomo)
...
result = client.compute_isochrone_boundary()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-spatial-isochrone-reachability-analyzer-skill": {
      "command": "python",
      "args": ["/path/to/genpark-spatial-isochrone-reachability-analyzer-skill/mcp_server.py"]
    }
  }
}
```
